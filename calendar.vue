...
var dateformat = function(mydate) {
  return (
    mydate.getFullYear() +
    "/" +
    (mydate.getMonth() + 1) +
...
var getDaysInOneMonth = function(mydate) {
...
var getMonthweek = function(mydate){
...
var getlist = function (mydate, that) {
  //渲染出来当前list
  var mygetMonth =
  ...
  var array = [];
  for (var i = 0; i < getDaysInOneMonth(mydate); i++) {
    if (
      dateformat(new Date()) ==
      dateformat(
        new Date(
  ...
  var array2 = [];
  for (var i = 0; i < getMonthweek(mydate); i++) {
